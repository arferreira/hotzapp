<div class="card card-profile bg-secondary shadow">
    <div class="card-header">
        <h5 class="h3 mb-0">{{ __("Horários de Atendimento")}}</h5>
    </div>
    <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="input-group">
                            ...
                            <input id="{{ $key.'_from' }}" name="{{ $key.'_from' }}" class="flatpickr datetimepicker form-control" type="text" placeholder="{{ __('Horário') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="input-group">
                            ...
                            <input id="{{ $key.'_to' }}" name="{{ $key.'_to' }}" class="flatpickr datetimepicker form-control" type="text" placeholder="{{ __('Horário') }}">
                        </div>
                    </div>
                </div>
                @endforeach

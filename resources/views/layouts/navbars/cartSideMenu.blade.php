                ...
                <div id="totalPrices" v-cloak>
                    <div  class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <span v-if="totalPrice==0">{{ __('Carrinho está vazio!') }}!</span>
                    ...
                    <div v-if="totalPrice" v-cloak class="text-center mobile-menu">
                        <a type="button" class="btn btn-default btn-block text-white btn-sm" style="text-transform:none" onclick="closeNav()">{{ __('Continuar comprando') }}</a>
                    </div>
                </div>
            </div>
        </div>

                ...
                <div class="card bg-gradient-default shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-light ls-1 mb-1">{{ __('Visão Geral') }}</h6>
                                <h2 class="text-white mb-0">{{ __('Valor em vendas') }}</h2>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <p class="text-white">{{ __('Sem vendas registradas no período!') }}</p>
                        @endif
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h2 class="mb-0">{{ __('Total de Pedidos') }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
